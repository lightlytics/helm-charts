...
![Version: 1.1.34](https://img.shields.io/badge/Version-1.1.34-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.1.4](https://img.shields.io/badge/AppVersion-1.1.4-informational?style=flat-square)
...
| streamsec.cost_image.digest | string | `"sha256:16d43c5922fd5d317c75562b13b4e4d3b1a336db630c218bb2da5d8fc7c9b190"` | Stream Security cost agent image digest to use. |
...
| streamsec.cost_image.tag | string | `"1.1.23"` | Stream Security cost agent tag to use. |
...
| streamsec.image.digest | string | `"sha256:16d43c5922fd5d317c75562b13b4e4d3b1a336db630c218bb2da5d8fc7c9b190"` | Stream Security agent image digest to use. |
...
| streamsec.image.tag | string | `"1.1.23"` | Stream Security agent tag to use. |
